    ...
    fs.createReadStream(filePath)
      ...
      .on('data', (row) => {
        hospitals.push({
          ...
          hospitalOverallRatingFootnote: row.hospitalOverallRatingFootnote || null,
...
if (require.main === module) {
  // const filePath = process.argv[2]; // ./src/data/Hospital_General_Information.csv
  const filePath = './src/data/Hospital_General_Information.csv';
  if (!filePath) {
