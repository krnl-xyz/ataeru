...
import { ArrowLeft, ArrowRight, Check, User, Building2, Mail, Lock, Phone, MapPin, FileText, Shield, Sparkles, CreditCard } from 'lucide-react';
              ...
              <div className="space-y-5">
                ...
                {/* <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-[#0a0a0a] border rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.hospitalId ? 'border-red-500' : 'border-gray-700'
                      }`}
                  />
                  {errors.hospitalId && <p className="text-red-400 text-sm mt-1">{errors.hospitalId}</p>}
                  <p className="text-gray-500 text-xs mt-1">Your unique hospital identifier</p>
                </div> */}
              </div>
            </div>
          )}
